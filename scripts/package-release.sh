...
case "$target" in
  x86_64-pc-windows-msvc|x86_64-pc-windows-gnu)
    omp_asset="omp-windows-x64.exe"; omp_name="omp.exe"; cli_name="agent-check.exe"; cargo_binary="agent-check.exe" ;;
  aarch64-apple-darwin)
    omp_asset="omp-darwin-arm64"; omp_name="omp"; cli_name="agent-check"; cargo_binary="agent-check" ;;
  x86_64-unknown-linux-gnu)
    omp_asset="omp-linux-x64"; omp_name="omp"; cli_name="agent-check"; cargo_binary="agent-check" ;;
  aarch64-unknown-linux-gnu)
    omp_asset="omp-linux-arm64"; omp_name="omp"; cli_name="agent-check"; cargo_binary="agent-check" ;;
