...
# Compatibility exports for callers that inspect the historical v2 partition.
CORE_TEST_IDS, ENHANCED_TEST_IDS = CONTRACT_VERDICT_PARTITIONS[V2_CONTRACT]
ALL_VERDICT_TEST_IDS = CONTRACT_TEST_IDS[V2_CONTRACT]
