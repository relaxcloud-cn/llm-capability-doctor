...
当前 v0.6.1 的 62 项目录使用固定优先级，不得根据单次结果升降级：
...
历史 v0.6.0 的 62 项目录使用与 v0.6.1 相同的固定优先级。

历史 v0.5.0 的 62 项目录使用与 v0.6.1 相同的固定优先级。

历史 v0.4.0 的 62 项目录使用与 v0.6.1 相同的固定优先级。
...
v0.3.0、v0.4.0、v0.5.0、v0.6.0 或 v0.6.1 编号含义。
...
The current v0.6.1 catalog has no long-output tests; apply these rules only to
...
For test `057` in v0.6.0 and v0.6.1, review all 4、8、16、32 concurrent waves. Treat
