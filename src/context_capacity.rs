...
mod tests {
    ...
    #[test]
    fn context_requirement_preserves_124k_tolerance() {
        assert_eq!(CONTEXT_MAIN_TARGET_TOKENS, 124_000);
        for tokens in [123_999, 124_000, 126_431, 127_999, 128_000] {
            let conclusion = conclude(&[
                (
                    tokens,
                    ProbeOutcome::Accepted {
    ...
    #[test]
    fn accepted_124k_probe_satisfies_requirement_with_a_higher_rejected_probe() {
        let conclusion = conclude(&[
            (
                124_000,
                ProbeOutcome::Accepted {
